...
export default function AdditionalColumnToggle() {
  const { showAdditionalColumn, toggleAdditionalColumn } = useSettings();

  return (
    <div className="mt-4 mb-4 flex items-center space-x-3 p-3 bg-white rounded-lg border border-gray-200">
      <span className="text-sm font-medium text-gray-700">
        {showAdditionalColumn ? 'Hide Additional Column' : 'Show Additional Column'}
      </span>
      <button
